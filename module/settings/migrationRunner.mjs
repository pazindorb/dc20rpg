...
const versions = [
                  ...
                  "0.9.7.2", "0.9.7.3", "0.9.8.0", "0.9.8.1", "0.9.8.2",
                  "0.10.0.0", "0.10.0.1", "0.10.0.2", "0.10.5.0", "0.10.5.1",
                  "0.10.6.0", "0.10.6.1", "0.10.7.0"
                ];
...
async function _runMigration(lastMigration, currentVersion, skipLastMigrationValueUpdate=false, migrateModules=[], testPath=false) {
  ...
  for (let i = after + 1; i <= until; i++) {
    ...
    const dialog =  new SimplePopup("info", {hideButtons: true, header: "Running Migration", information: [`Running system migration for version: ${migratingTo}... Please wait it might take a while. This window will be closed once the migration is complete. Go make yourself a coffee :D`]});
